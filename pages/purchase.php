...
<head>
	<title>amba</title>
	<link rel="stylesheet" type="text/css" href="../../css/style/purhase_style.css">
	<link rel="stylesheet" type="text/css" href="../../css/media/purhase_media.css">
				...
				<div id="daily">
					<div id="header_space"></div>
					 <div id="header">
						...
						<div id="font">
							<font class="header_amba">Покупки</font>
						</div>
					</div>
					<div id="space1"></div>
					<div id="content_tasks">
						<div id="section_content">
							<div id="section_1">
								<div id="purhase_1">
									<div id="purhase_id">
										<font class="purhase_id">4GD6HH</font>
									</div><div id="margin_space"></div>
									<div id="club_name">
										<font class="club_name">Portal</font><br>
										<font class="purhase_article">пакет 12 часов </font>
									</div>
									<div id="price">
										<font class="price">1200 C</font><br>
										<font class="date">22.02.2020</font>
									</div>
								</div>
