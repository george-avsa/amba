...
<head>
	<title>amba</title>
	<link rel="stylesheet" type="text/css" href="../../css/style/awaiting_tasks_style.css">
	<link rel="stylesheet" type="text/css" href="../../css/media/awaiting_tasks_media.css">
				...
				<div id="daily">
					<div id="header_space"></div>
					 <div id="header">
						...
						<div id="font">
							<font class="header_amba">Отложенные задания</font>
						</div>
					</div>
					<div id="space1"></div>
						...
						<div id="icons">
							<div id="list_icon">
								<a href="all_tasks.php">
									<img src="../svg/all_tasks_purple.svg">
								</a>
							</div>
							<div id="wait_icon">
							...
							<div id="complete_icon">
								<a href="awaiting_tasks.php">
									<img src="../svg/awaiting_tasks_blue.svg">
								</a>
							</div>
