...
<head>
	<title>amba</title>
	<link rel="stylesheet" type="text/css" href="../../css/style/heirs_style.css">
	<link rel="stylesheet" type="text/css" href="../../css/media/heirs_media.css">
				...
				<div id="daily">
					<div id="header_space"></div>
					 <div id="header">
						...
						<div id="font">
							<font class="header_amba">Наследники</font>
						</div>
					</div>
					<div id="space1"></div>
					<div id="content_tasks">
						<div id="section_content">
							<div id="section_1">
							<?php
							$all_tasks =  R::findAll('heirs', "id != ?", array(0));
							foreach ($all_tasks as $key => $bean) {
							$heir_in_users =  R::findOne('users', "unical_id = ?", array($bean->heir_id));
							$task_in_tasks =  R::findOne('tasks', "executor_id = ?", array($bean->heir_id));

							echo "<div class='heirs'>
                                    <div id='heir_id'>
                                            <font class='heir_id'>ID ".$bean->heir_id."</font><br>
                                            <font class='heir_name'>".$heir_in_users->name." ".$heir_in_users->last_name."</font>
                                    </div>
                                    <div id='heir_lvl'>
                                            <font class='heir_id'>lvl</font><br>
                                            <font class='heir_name'>".$bean->heir_lvl."</font>
                                    </div>
                                    <div id='price'>
                                            <font class='heir_id'>".$task_in_tasks->price." C</font><br>
                                            <font class='heir_name'>Заработано</font>
                                    </div>
                                    <div id='paid_coins'z>
                                            <font class='paid_coins'>+".(($task_in_tasks->price)*$heir_pay_coeff)." С</font><br>
                                            <font class='heir_name'>За задание</font>
                                    </div>
                            	</div>";
                            }
							?>
