...
<head>
	<title>amba</title>
	<link rel="stylesheet" type="text/css" href="../../css/style/shop_style.css">
	<link rel="stylesheet" type="text/css" href="../../css/media/shop_media.css">
				...
				<div id="daily">
					<div id="header_space"></div>
					 <div id="header">
						...
						<div id="font">
							<font class="header_amba">Магазин</font>
						</div>
					</div>
					<div id="shop_list">
						<div id="list_content">
							<div id="shop_name" style="background: #302F74;"> 
							
							</div>
							<div id="shop_name" class="middle_name">
					...
					<div id="space_wrapper"></div>
					<div id="shops_wrapper">
						<div id="shop">
							<div id="space_shop1"></div>
							<div id="club_name">
								<font class="club_name">
									United Gamers
								</font>
							</div>
							<div id="club_article">
								<font class="club_article">
									Компьютерный клуб
								</font>
							</div>
							<div id="space_shop3"></div>
							<div id="star"></div>
						</div>
						<div id="shop">
							<div id="space_shop1"></div>
